    ...
    public static void makeDefaultPhone(Context context) {
        synchronized(Phone.class) {
            if (!sMadeDefaults) {
                ...
                } else if ("motow3gplain".equals(sRILClassname)) {
                    Log.i(LOG_TAG, "Using Motorola Wrigley 3G plain RIL");
                    sCommandsInterface = new MotoWrigley3GPlainRIL(context, networkMode, cdmaSubscription);
                } else {
